...
class DvachPostCreateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => NeuralNetResponseCreateNestedManyWithoutDvachPostsInput,
  })
  @ValidateNested()
  @Type(() => NeuralNetResponseCreateNestedManyWithoutDvachPostsInput)
  @IsOptional()
  @Field(() => NeuralNetResponseCreateNestedManyWithoutDvachPostsInput, {
    nullable: true,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => PromptCreateNestedManyWithoutDvachPostsInput,
  })
  @ValidateNested()
  @Type(() => PromptCreateNestedManyWithoutDvachPostsInput)
  @IsOptional()
  @Field(() => PromptCreateNestedManyWithoutDvachPostsInput, {
    nullable: true,
  })
  prompts?: PromptCreateNestedManyWithoutDvachPostsInput;
}

export { DvachPostCreateInput as DvachPostCreateInput };
